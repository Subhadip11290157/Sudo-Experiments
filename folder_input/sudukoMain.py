...
if biggest.size != 0:
    ...
    img = stackedImage
    # resize display image, credits to : https://www.codegrepper.com/code-examples/python/opencv+how+to+set+window+size
    imo = cv2.resize(img, (960, 540))
    cv2.imshow('Stacked Images', imo)
    # I tried these to resize the output display window but that didn't work as I expected
